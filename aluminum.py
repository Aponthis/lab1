# MEE322 Lab 1 - Data Plots for Aluminum
...
length = 31.97 # Original length, mm

dir_path = os.path.dirname(os.path.realpath(__file__))

df = pd.read_csv (dir_path + r'\aluminum.csv')
...
plt.title('Engineering Stress-Strain for Aluminum Sample')
...
begin = 10
threshold = 100 # first n values to perform regression on
...
plt.title('True Stress-Strain for Aluminum Sample')
...
plt.title('Log-Log True Stress-Strain for Aluminum Sample')
